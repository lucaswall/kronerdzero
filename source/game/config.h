...
#define SPRITE_MAX_FRAMES 12
#define MAX_SPRITE 200
#define SCREEN_SHAKE_AMPLITUDE 2
#define SCREEN_SHAKE_DURATION (TIMER_SEC / 4 * 3)
#define ENEMY_HIT_SLEEP (TIMER_SEC / 50)

#define MAX_ENEMY 100
#define ENEMY_DELAY (TIMER_SEC * 3 / 2)
#define ENEMY01_MOVE_LEFT_DELAY (TIMER_SEC / 100)
#define ENEMY01_MOVE_AMPLITUDE 40
